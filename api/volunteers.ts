...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    try {
        ...
        if (req.method === 'POST') {
            ...
            const volunteer = await prisma.volunteer.create({ data: { userId: body.userId, skills: body.skills || [], certifications: body.certifications || [], status: 'AVAILABLE' }, include: { user: { select: { fullName: true, email: true, role: true } } } })
